...
def fitness(agents, n_qubits, n_gates, H, initial_state):
    ...
    for agent in agents:
        ...
        open_qasm_circuit = dev._circuit.qasm(formatted=True)
        print("OpenQASM Circuit:", open_qasm_circuit)
        job = vqe_runner(
        ...
        agent.fitness = - energy['fun'] - total_complexity * 0.0001
        agent.energy = energy['fun']
...
if __name__ == "__main__":
    token = 'a300e18a60c69a888228f56f06b36e2826da552eccb046f29d7a70a1aa3966014cb0c933916ad63cb1aa050dfd99045b7da7b9bd701302ace964dbfee808a84c'
    IBMQ.enable_account(token)
    program_id = upload_vqe_runner(hub="ibm-q-community", group="cdl-hackathon", project="main")
